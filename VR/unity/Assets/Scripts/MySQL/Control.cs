...
public class Control : MonoBehaviour
{
    ...
    public void RemoteControl()
    {
        ...
        {
            // string query = string.Format("insert into feedback (x,y,z) values ({0},{1},{2});", -zFrame.transform.position.x, -zFrame.transform.position.z, -zFrame.transform.position.y);
